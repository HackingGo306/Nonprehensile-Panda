...
Everything runs locally in the browser, with no account or server required. Use the camera controls to explore the warehouse scene and open **Info** for live simulation details.
